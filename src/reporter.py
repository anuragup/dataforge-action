...
def generate_markdown(filename: str, result: ProcessResult, score_data: dict, privacy_mode: bool = True) -> str:
    ...
    # Footer
    lines.append("---")
    lines.append("_Generated by [DataForge](https://github.com/marketplace/actions/dataforge-data-quality-check) · Your data never leaves your GitHub runner · [Security policy](https://github.com/yourname/dataforge-action/security/policy)_")
...
<div class="container">
  ...
  <div class="footer">
    ...
    <a href="https://github.com/yourname/dataforge-action">github.com/yourname/dataforge-action</a>
  </div>
</div>
</body>
</html>"""
